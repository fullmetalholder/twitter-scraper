...
declare function getFollowing(userId: string, maxProfiles: number, auth: TwitterAuth): AsyncGenerator<Profile, void>;
declare function getFollowers(userId: string, maxProfiles: number, auth: TwitterAuth): AsyncGenerator<Profile, void>;
declare function fetchProfileFollowing(userId: string, maxProfiles: number, auth: TwitterAuth, cursor?: string): Promise<QueryProfilesResponse>;
declare function fetchProfileFollowers(userId: string, maxProfiles: number, auth: TwitterAuth, cursor?: string): Promise<QueryProfilesResponse>;
/**
 ...
 */
declare function followUser(auth: TwitterAuth, username: string): Promise<Response>;
 ...
 */
declare function uploadMedia(auth: TwitterAuth, mediaData: MediaData): Promise<string>;
/**
 * Create a tweet
 * @param auth Twitter authentication
 ...
 * @returns The response from Twitter
 */
declare function createTweet(auth: TwitterAuth, text: string, options?: CreateTweetOptions): Promise<Response>;
/**
 * Retweet a tweet
 * @param auth Twitter authentication
 ...
 * @returns The response from Twitter
 */
declare function retweet(auth: TwitterAuth, tweetId: string): Promise<Response>;
/**
 * Remove a retweet
 * @param auth Twitter authentication
 ...
 * @returns The response from Twitter
 */
declare function unretweet(auth: TwitterAuth, tweetId: string): Promise<Response>;
/**
 * Like a tweet
 * @param auth Twitter authentication
 ...
 * @returns The response from Twitter
 */
declare function likeTweet(auth: TwitterAuth, tweetId: string): Promise<Response>;
/**
 * Unlike a tweet
 * @param auth Twitter authentication
 ...
 * @returns The response from Twitter
 */
declare function unlikeTweet(auth: TwitterAuth, tweetId: string): Promise<Response>;
...
declare class Scraper {
     ...
     * @returns The response from Twitter.
     */
    sendTweet(text: string, replyToTweetId?: string, mediaData?: MediaData[]): Promise<Response>;
    /**
     * Send a quote tweet.
     ...
     * @returns The response from Twitter.
     */
    sendQuoteTweet(text: string, quotedTweetId: string, mediaData?: MediaData[]): Promise<Response>;
    /**
     * Retweet a tweet.
     * @param tweetId The ID of the tweet to retweet.
     * @returns The response from Twitter.
     ...
     * @returns The response from Twitter.
     */
    unretweet(tweetId: string): Promise<Response>;
    /**
     * Like a tweet.
     * @param tweetId The ID of the tweet to like.
     * @returns The response from Twitter.
